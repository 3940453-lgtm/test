    ...
    $(document).ready(function () {
        ...
        $.getJSON("../plugins/LandingPage/config.json", function (json) {
            ...
            $('#solutions-panel-create').attr('href',
                json.EnterpriseApplication === 'Tutorial'
                    ? 'mstrWeb?Project=MicroStrategy+Tutorial&Port=0?evt=3187&src=mstrWeb.3187'
                    : 'mstrWeb?Project='
                    + json.MainProject
            ...
            $('#resources-cards-desktop-launch-mobile').attr('href', json.mstrDesktop) //'http://microstrategy.com/us/desktop')
                .parent()
                .toggle(isMobile.any());
            $('#resources-cards-desktop-launch').attr('href', json.mstrDesktop /*'http://microstrategy.com/us/desktop'*/).parent().parent()
                .toggle(isMobile.any());
            ...
            if (json.serverOS.toLowerCase() == 'linux') {
                ...
                $.each(json.serverBoxIP.map(function (e) { return e + ':3389'; }), function (i, v) {
                    var hostname = 'PlatformInstanceHostname0' + (i + 1);
