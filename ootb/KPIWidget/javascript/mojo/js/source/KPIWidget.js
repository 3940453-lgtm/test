        ...
        null,
        {
            ...
            measureTextSize: function (string, fs, bonus) {
                return {
                    ...
                    //should force to single line when measure text height
            ...
            getCurrTextSize: function getCurrTextSize() {
                var isCurrSingleRowMode = this.getDisplayMode() === SINGLE_ROW_MODE,
                    metricNameTextSize = isCurrSingleRowMode ? {
                        width: 0,
                        height: 0
                    } : this.measureTextSize(this.metricNameNode.textContent, this.getNameFontStyle()),
                    metricValueTextSize = this.measureTextSize(this.metricValueNode.textContent, this.getValueFontStyle()),
            ...
            doFitToPage: function doFitToPage() {
                ...
                if (currSize.width > maxWidth && isCurrSingleRowMode) {
                    ...
                    this.metricValueNode.textContent = this.metricValue;
                    currSize = this.getCurrTextSize();
                }
            ...
            plot: function () {
                ...
                if (this.getDisplayMode() === SINGLE_ROW_MODE) {
                    ...
                    if (/\S/.test(this.metricName)) {
                        this.metricValueNode.textContent = this.metricName + SEPARATOR + this.metricValue;
                    } else {
                    ...
                    //TWO ROW MODE
                    this.metricNameNode.textContent = this.metricName;
                    this.metricValueNode.textContent = this.metricValue;
            ...
            getFontStyle: function getFontStyle(isMetricValue) {
                ...
                if (isMetricValue) {
                    ...
                    if (returnColor == null) {
                        ...
                        //change default metric font color to black in light theme
                ...
                //This lineHeight is used when measure text height and set apply style. But lineHeight in getComputedStyle will become pixel value on workstation on mac, which will impact the div real height. So use 'normal' here.
