...
--%>
<html xmlns:v="urn:schemas-microsoft-com:vml" <web:ifFeature name="accessibility"><web:then>lang=<web:connectionValue property="displayLocale"/></web:then></web:ifFeature>>
      <web:performanceTimer action="initialize"/><web:performanceTimer action="start"/>
<head>
<!--[if IE]>
<style>
...
<!--  favicon -->
<link rel="shortcut icon" href="../plugins/WebPlugin/style/mstr/images/limagrain_logo.ico" type="image/x-icon" />
<!--  end favicon -->
