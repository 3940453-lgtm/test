(function () {
    ...
    mstrmojo.plugins.D3Mekko.D3Mekko = mstrmojo.declare(
        ...
        null,
        {
            ...
            externalLibraries: [{url: "//d3js.org/d3.v3.min.js"}, {url: "//cdnjs.cloudflare.com/ajax/libs/dimple/2.2.0/dimple.latest.min.js"}],
            ...
            plot: function () {
                ...
                for (var i = 0; i < rawDRows.length; i++) {
                    ...
                    for (var name in object) {
                        var metric = object[name];
                        if (typeof metric === "object") {
                            object[name] = typeof metric.rv === 'number' ? metric.rv : metric.v;
                        }
                    }
                    dataS.push(object);
                }
                ...
                mySeries.addEventHandler("click", function (e) {
                    ...
                    if (selectedRect === className) {
                        ...
                        var selection = rawD.children[dateIndexMap[e.frameValue]].children[seriesIndexMap[e.seriesValue[0]]].children[0].attributeSelector;
