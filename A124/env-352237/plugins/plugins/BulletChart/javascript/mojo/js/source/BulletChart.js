(function () {
    ...
    var paddingForScroller = 13;//Y-Scrooler
    ...
    function updateColumnWidth() {
        ...
        var colInfos = this.colsInfo,
            legendWidth = this.legend.offsetWidth + 10,//40 for margin
        ...
        [mstrmojo.ui._HasScroller],
        {
            ...
            onclick: function (evt) {
                ...
                if (selection) {
                    ...
                    //using visualization as filter configuration including mobile
                    if (window.webkit && window.webkit.messageHandlers && window.webkit.messageHandlers.selectionDataJSONString) { //for mobile
                             ...
                             this.applySelection(selection); //for web
                           }



                    //this.applySelection(selection); //default configuration for using visualization as filter only for web
                }
            ...
            renderBulletChart: function () {
                ...
                for (var i = 0; i < colLen; i++) {
                    ...
                    tds[i].style.maxWidth = (colInfo.colWidth - colInfo.padding.right - colInfo.padding.left) + 'px';
            ...
            plot: function () {
                ...
                this.advancedModel = (new $DI(this.model.data)).getRawData($DI.ENUM_RAW_DATA_FORMAT.ROWS_ADV, {
                    hasTitleName: true,
                    hasSelection: true,
                    needDecode: true
                });
            ...
            markupString: '<div id="{@id}-bulletchart" class="mstrmojo-Chart {@cssClass}"   mstrAttach:mouseover,mouseout,click >'

            + '<div id="{@id}-bulletchart-table" class="mstrmojo-Chart  bulletchart-Table " style="position:absolute">'
